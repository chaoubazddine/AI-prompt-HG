          ...
          <tbody>
            {data.introductionSteps.map((step, index) => (
              <tr key={index} style={{ backgroundColor: index % 2 === 0 ? '#ffffff' : '#f8fafc' }}>
                ...
                <td className="border-l-2 border-black p-4 text-right whitespace-pre-wrap leading-relaxed">
                ...
                return (
                  <tr key={index} className="font-bold" style={{ backgroundColor: '#ECFDF5' }}>
                    ...
                    <td colSpan={5} className="p-4 text-right">
                      ...
                      <div className="font-normal leading-relaxed text-slate-700 whitespace-pre-wrap pr-4">
                        {step.teacherActivities}
                      </div>
                    </td>
                  </tr>
